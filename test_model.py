...
def test(data_loader, network, args):
    ...
    with torch.no_grad():
        for images, captions, labels, mask, img_paths in data_loader:
            ...
            # image_embeddings1,image_embeddings2,image_embeddings3, text_embeddings = network(images, captions, mask)
            # inference 的时候3个目标加起来~
            # images_bank[index: index + interval] = image_embeddings3
